          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-2xl border bg-slate-50 px-4 py-3.5 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:bg-white focus:ring-2 focus:ring-slate-900/8 ${fieldError === "email" ? "border-red-400 focus:border-red-400" : "border-slate-200 focus:border-slate-400"}`}
              />
            </div>
